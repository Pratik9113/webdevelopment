...
def main():
    print("Welcome to VESIT University Portal!!!")
    ...
    while True:
        ...
        if choice == 1:
            ...
            ch = input()[0]
            if ch == "A":
                print("Congratulations!! You are now a CSE student at VESIT")
                break
        elif choice == 2:
            ...
            ch = input()[0]
            if ch == "A":
                print("Congratulations!! You are now an IT student at VESIT")
                break
        elif choice == 3:
            ...
            ch = input()[0]
            if ch == "A":
                print("Congratulations!! You are now an ECE student at VESIT")
                break
        elif choice == 4:
            ...
            ch = input()[0]
            if ch == "A":
                print("Congratulations!! You are now an EE student at VESIT")
                break
        elif choice == 5:
            ...
            ch = input()[0]
            if ch == "A":
                print("Congratulations!! You are now a ME student at VESIT")
                break
        elif choice == 10:
            break
        else:
